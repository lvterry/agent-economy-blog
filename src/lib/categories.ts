export const categoryMap: Record<string, string[]> = {
  "AI Infra": ["AI-Infrastructure", "Hardware", "Data-Center", "GPU", "TPU", "Supply-Chain", "Infrastructure", "Tinygrad", "Deep-Learning", "Durable-Execution", "PostgreSQL", "Model-Compression", "Edge-Computing", "vLLM", "Vector-Database", "RAG", "Distributed-Computing", "MCP", "Tokenization", "RISC-V", "CUDA", "DuckDB"],
  ...
  "安全与隐私": ["AP2", "AI-Advertising", "Security", "Privacy", "AI-Safety", "Prompt-Injection", "Financial-Security", "GrapheneOS", "C2PA"],
